...
"""
Configuration utilities for the ChatQnA Core application.

This module provides functions for reading ChatQnA Core-specific configuration
...
def get_chatqna_profile_details(profile_path, config, warmup=False):
    """
    Retrieve chat/stream-log profile details for ChatQnA Core applications.
